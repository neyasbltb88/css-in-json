...
function () {
  ...
  _createClass(CSSinJSON, [{
    ...
    value: function objToStyle(selector, obj, scoped) {
      var root_detect = selector === this.elem_selector ? '' : ' ';
      ...
      return "".concat(scoped_selector).concat(root_detect).concat(selector, " {").concat(style, "\n}");
    }
  }, {
    key: "jsonToStyle",
...
var style_info = document.querySelector('.style_info');
var CSSinJSON_style = document.querySelector('.CSSinJSON_style');
var style_show = document.querySelector('.style_show');
var json_show = document.querySelector('.json_show');
var base_selector = document.querySelector('.base_selector');
style_info.textContent = "\u0412 body \u0432\u0441\u0442\u0430\u0432\u043B\u0435\u043D \u0442\u0435\u0433 <style id=\"".concat(CSSinJSON_style.id, " class=\"").concat(CSSinJSON_style.className, "\"></style>");
